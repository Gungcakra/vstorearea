<div class="modal fade" tabindex="-1" id="departementModal" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">{{$departementId ? 'Edit' : 'Add'}} Departement</h3>
            ...
            <div class="modal-body">
                {{-- <form id="kt_modal_new_target_form" class="form" wire:submit.prevent="{{ isset($departementId) ? 'update' : 'store' }}"
                > --}}
                ...
                <div class="row g-9 mb-8">
                    ...
                    <div class="d-flex flex-column col-md-6 mb-8 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solid  @error('salary') is-invalid @enderror" placeholder="Enter Salary" autocomplete="off" id="position" wire:model="salary" />
                    </div>
                </div>
                <!--end::Input group-->
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" wire:click="{{ isset($departementId) ? 'update' : 'store' }}">{{ $departementId ? 'Update' : 'Store' }}</button>
