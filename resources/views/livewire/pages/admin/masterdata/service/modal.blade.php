<div class="modal fade" tabindex="-1" id="ServiceModal" aria-hidden="true" wire:ignore.self>
            ...
            <div class="modal-body">
                ...
                <div class="row g-9 mb-8">
                    ...
                    <div class="d-flex flex-column col-md-6 mb-8 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solidc @error('price') is-invalid @enderror" placeholder="Enter Price" autocomplete="off" id="price" wire:model="price" />
                    </div>
                </div>
                <!--end::Input group-->
