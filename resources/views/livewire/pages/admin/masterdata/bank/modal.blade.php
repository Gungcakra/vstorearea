            ...
            <div class="modal-body">
                ...
                <div class="row g-9 mb-8">
                    ...
                    <div class="d-flex flex-column col-md-6 mb-8 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solid  @error('account_number') is-invalid @enderror" placeholder="Enter Account Number" autocomplete="off" id="position" wire:model="account_number" />
                    </div>
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="row g-9 mb-8">
                    <div class="d-flex flex-column col-md-12 mb-8 fv-row">
                        ...
                        <input type="text" class="form-control form-control-solid  @error('amount') is-invalid @enderror" placeholder="Enter Name" id="name" autocomplete="off" wire:model="amount" />
                    </div>
                </div>
