    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        <a href="{{ route('dashboard') }}">
            <div class="d-flex app-sidebar-logo-default align-items-center">
                <img alt="Logo" src="{{ asset('assets/media/logos/default-logo.svg') }}" class="h-50px app-sidebar-logo-default" />
            <p class="app-sidebar-logo-default text-white fw-bold fs-2">Garage Pro</p>
            </div>
            <img alt="Logo" src="{{ asset('assets/media/logos/default-logo.svg') }}" class="h-40px app-sidebar-logo-minimize" />
        </a>
